        ...
        <div className="md:flex items-center justify-between sm:flex-col md:flex-row">
          ...
          <div className="w-full md:basis-1/2">
            ...
            >
              ...
              I am a passionate and highly motivated full stack software engineer with comprehensive training in
              a wide array of cutting edge technologies. My skill set includes proficiency in:
            </p>
            <div className='flex items-center gap-9 mt-14'>
                ...
                <span>
                    <a href="#twitter" className="text-smallTextColor text-[18px] font-[600]">
                    <i class="ri-twitter-x-line"></i>
                    </a>
                </span>
                <span>
                    <a href="#wordpress" className="text-smallTextColor text-[18px] font-[600]">
